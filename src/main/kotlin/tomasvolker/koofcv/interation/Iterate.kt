package tomasvolker.koofcv.interation
...
): List<Point2D_I32> = mutableListOf<Point2D_I32>().apply {
    forEachPixel { x, y, value ->
        if(predicate(x, y, value)) add(Point2D_I32(x, y))
    }
}

fun GrayU8.nonZeroPoints(): List<Point2D_I32> = points { x, y, value -> value != 0 }
